	...
	<head>
		...
		<script>  
			...
			function addPersonnelPermanentAppointment(){
			    window.location.href="/personnelAppoint/addPermanentAppointment";
			}
					...
					<table id="table" class="table table-bordered">
						...
						<tbody>
							<c:forEach var="personnel" items="${permanentAppointmentList}">
								<tr>
									<td><a href="/personnelAppoint/detailPermanentAppointment?appointmentSchoolPersonnelNumber=${personnel.appointmentSchoolPersonnelNumber}">${personnel.appointmentSchoolPersonnelNumber}</a></td>
