	...
	<head>
		...
		<script>  
			...
			$(document).ready(function(){
				var number = ${detailPermanentAppointment.appointmentSchoolPersonnelNumber};
		...
		<div id="wrapper">
			...
			<div id="content-wrapper">
				...
				<!-- 여기에 내용이 담긴다 -->
					<h1>인사관리 > 임명관리</h1>
					<br>
					<p id="enrolScoreMain">* 정규직 상세정보</p>
					<form id="form">
					...
					<table id="table" class="table table-bordered">
						...
						<tbody>
							<tr>
								<td><img src="${detailPermanentAppointment.humanPicture}"></td>
								<td>${detailPermanentAppointment.appointmentSchoolPersonnelNumber}</td>
								<td>${detailPermanentAppointment.humanName}</td>
			                    <td>${detailPermanentAppointment.humanNameEnglish}</td>
			                    <td>${detailPermanentAppointment.countryNameKorean}</td>
			                    <td>${detailPermanentAppointment.humanGender}</td>
			                    <td>${detailPermanentAppointment.humanResidentRegistrationNumber}</td>
			                    <td>${detailPermanentAppointment.humanMilitaryService}</td>
								<td>${detailPermanentAppointment.personnelCommonAppointmentCodeName}</td>
								<td>${detailPermanentAppointment.teamNameKorean}</td>
								<td>${detailPermanentAppointment.jobRankNameKorean}</td>
								<td>${detailPermanentAppointment.jobTypeName}</td>
								<td>${detailPermanentAppointment.jobGroupName}</td>
								<td>${detailPermanentAppointment.appointmentAppointDay}</td>
								<td>${detailPermanentAppointment.appointmentPermanentAnnualIncome}</td>
								<td>${detailPermanentAppointment.appointmentPermanentCareerDivision}</td>
								<td>${detailPermanentAppointment.appointmentPermanentContractStartTerm}</td>
								<td>${detailPermanentAppointment.appointmentPermanentContractEndTerm}</td>
								<td>${detailPermanentAppointment.appointmentPermanentAppointmentStartTerm}</td>
								<td>${detailPermanentAppointment.appointmentPermanentAppointmentEndTerm}</td>
								<td>${detailPermanentAppointment.appointmentPermanentSalaryclass}</td>
								<td>${detailPermanentAppointment.appointmentPermanentSalaryclassPromotion}</td>
								<td>${detailPermanentAppointment.appointmentPermanentAppointReason}</td>
							</tr>
						</tbody>
					</table>
					<br>
