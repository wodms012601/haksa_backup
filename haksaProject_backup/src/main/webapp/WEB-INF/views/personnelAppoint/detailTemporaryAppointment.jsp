...
<html lang="ko">
	<head>
		...
		<script>  
			...
			// 조회 버튼 눌렀을 시 페이지 이동
			function listTemporaryAppointment(){
			    window.location.href="/personnelAppoint/listTemporaryAppointment";
			}
			
			$(document).ready(function(){
				var number = ${detailTemporaryAppointment.appointmentSchoolPersonnelNumber};
		...
		<div id="wrapper">
			...
			<div id="content-wrapper">
				...
				<!-- 여기에 내용이 담긴다 -->
					<h1>인사관리 > 임명관리</h1>
					<br>
					<p id="enrolScoreMain">* 비정규직 상세정보</p>
					<form id="form">
					...
					<br>
					<form id="form">
						<input type='button' class="btn btn-info" onclick='listTemporaryAppointment()' value='조회'/>
					...
					<table id="table" class="table table-bordered">
						...
						<tbody>
							<tr>
								<td><img src="${detailTemporaryAppointment.humanPicture}"></td>
								<td>${detailTemporaryAppointment.appointmentSchoolPersonnelNumber}</td>
								<td>${detailTemporaryAppointment.humanName}</td>
			                    <td>${detailTemporaryAppointment.humanNameEnglish}</td>
			                    <td>${detailTemporaryAppointment.countryNameKorean}</td>
			                    <td>${detailTemporaryAppointment.humanGender}</td>
			                    <td>${detailTemporaryAppointment.humanResidentRegistrationNumber}</td>
			                    <td>${detailTemporaryAppointment.humanMilitaryService}</td>
								<td>${detailTemporaryAppointment.personnelCommonAppointmentCodeName}</td>
								<td>${detailTemporaryAppointment.teamNameKorean}</td>
								<td>${detailTemporaryAppointment.jobRankNameKorean}</td>
								<td>${detailTemporaryAppointment.jobTypeName}</td>
								<td>${detailTemporaryAppointment.jobGroupName}</td>
								<td>${detailTemporaryAppointment.appointmentAppointDay}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryCareerDivision}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryContractStartTerm}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryContractEndTerm}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryAppointmentStartTerm}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryAppointmentEndTerm}</td>
								<td>${detailTemporaryAppointment.appointmentTemporaryAppointReason}</td>
							</tr>
						</tbody>
					</table>
					<br>
