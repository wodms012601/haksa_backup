...
public class ScheduleController {
	...
	// 건물명 조회
	@RequestMapping(value="/rest/schedule/building", method=RequestMethod.GET)
	...
	// 강의실 조회
	@RequestMapping(value="/rest/schedule/room", method=RequestMethod.GET)
	...
	// 년도, 학기 조회
	@RequestMapping(value="/rest/schedule/semester", method=RequestMethod.GET)
	...
	// 학과 조회
	@RequestMapping(value="/rest/schedule/department", method=RequestMethod.GET)
	...
	// 학년 조회
	@RequestMapping(value="/rest/schedule/grade", method=RequestMethod.GET)
	...
	// 반 조회
	@RequestMapping(value="/rest/schedule/class", method=RequestMethod.GET)
	...
	// 시간표 조회
	@RequestMapping(value="/rest/schedule/scheduleStateList", method=RequestMethod.POST)
	...
	// 교수 시간표 조회
	@RequestMapping(value="/rest/schedule/professorSchedule", method=RequestMethod.POST)
	...
	// 강의실 시간표 조회
	@RequestMapping(value="/rest/schedule/roomSchedule", method=RequestMethod.POST)
	public @ResponseBody List<Schedule> roomScheduleList(Search search) {
